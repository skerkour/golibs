...
func (client *Client) AddCustomHostname(zone, hostname string) (hostnameID string, err error) {
...
func (client *Client) RemoveCustomHostname(zone, hostnameID string) (err error) {
	err = client.request(requestParams{
...
func (client *Client) GetCustomHostnameDetails(zone, hostnameID string) (res CustomHostname, err error) {
	err = client.request(requestParams{
